...
@Component({
  selector: 'recruiter-edit-vacancy',
  standalone: true,
  imports: [
...
export class RecruiterEditVacancyComponent implements OnInit {
  ...
  ubicaciones = ['Ciudad de Guatemala','Quetzaltenango','Antigua Guatemala','Escuintla','Mixco'];
  ...
  cancelar() { this.router.navigate(['/reclutador/vacantes']); }
}
